...
const Profile = () => {
    ...
    <div className="profile-page">
        ...
        <button className='back-button' 
            ...
            <img src={back_icon} 
                alt='Back button' 
                className='back-to-netflix'/> Back to Netflix 
        </button>
                ...
                <div className="quick-links">
                    ...
                    <ul className='link-list'>
                        <li onClick={() => {
                            ...
                            }}> <img src={edit_icon} alt="Edit Logo"/> Edit Name 
                        </li>                       
                            {isEditName? 
                            <span>
                                <input type='text'
                        ...
                        <li onClick={() => {
                            ...
                            setShowModal(true)
                            }}> <img src={password_icon} alt="Edit Logo"/> Update Password 
                        </li>
                        <li onClick={() => {
                            setShowModal(true)
                            setIsUpdatePassword(false)
                            }}> <img src={delete_icon} alt="Delete Logo"/> Delete Account 
                        </li>
                    </ul>
                </div>
            </div>
